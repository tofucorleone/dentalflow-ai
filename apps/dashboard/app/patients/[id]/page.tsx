...
import { PatientNoteDeleteButton } from "@/components/patient-note-delete-button";
      ...
      <section className="patient-profile-grid">
        <article className="panel">
          <div className="patient-hero">
            <div className="avatar patient-large">
              {(data.patient.full_name ?? "P").slice(0, 1).toUpperCase()}
            </div>
          ...
          <PatientEditForm patient={data.patient} />
        ...
        <article className="panel">
          ...
          <p className="patient-memory">
            {data.memory?.summary ??
              "Aucun résumé IA enregistré pour ce patient."}
          </p>
            ...
            {data.appointments.map((a) => (
              <div className="timeline-item" key={a.id}>
                <div>
                  ...
                  <span>
                    {a.practitioner_name ?? "Praticien"} · {a.status}
                  </span>
                </div>
